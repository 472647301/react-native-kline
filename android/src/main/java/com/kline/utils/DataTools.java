...
//            points[indexInterval * i + Constants.INDEX_DATE] = point.getHighPrice();
            ...
            points[indexInterval * i + Constants.INDEX_VOL] = point.getVolumeCount();
            ...
            //vol ma计算
            volumeMaOne += point.getVolumeCount();
            volumeMaTwo += point.getVolumeCount();
            float ma;
            if (i == maOne - 1) {
                ma = (float) (volumeMaOne / maOne);
            } else if (i > maOne - 1) {
                volumeMaOne -= dataList.get((int) (i - maOne)).getVolumeCount();
                ma = (float) (volumeMaOne / maOne);
            } else {
                ma = Float.MIN_VALUE;
            }
            ...
            if (i == maTwo - 1) {
                ...
                volumeMaTwo -= dataList.get((int) (i - maTwo)).getVolumeCount();
                ma = (float) (volumeMaTwo / maTwo);
            } else {
                ma = Float.MIN_VALUE;
            }
